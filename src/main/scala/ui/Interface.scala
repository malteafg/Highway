...
object Interface {
    ...
    val panel: UIComponent = new UIComponent(Array(button1, button2, button3), new Vector2f(), new Vector2f(3, 9), Vals.UNIT, new Vector3f())
    ...
    val screen: UIComponent = new UIComponent(Array(panel, slider, textField), new Vector2f(), new Vector2f(16, 9), Vals.UNIT, new Vector3f())
